...
program
    ...
    .option(
        '-jq, --jpg-qlt <number>',
        'Jpg compression quality, in range 0 to 100.',
        Number,
        JPG_QUALITY_DEFAULT_VALUE,
    )
    .option(
        '-minpq, --min-png-qlt <number>',
        'Minimal png compression quality, in range 0 to 1.',
        Number,
        PNG_MIN_QUALITY_DEFAULT_VALUE,
    )
    .option(
        '-maxpq, --max-png-qlt <number>',
        'Maximum png compression quality, in range 0 to 1.',
        Number,
        PNG_MAX_QUALITY_DEFAULT_VALUE,
    )
    .parse(process.argv);
